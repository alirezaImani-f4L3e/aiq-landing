...
const Content = memo(() => {
  ...
  return (
    ...
    >
      <Link
        href={"https://chat.aiqueue.ir/files"}
        style={{ marginBottom: "16px", width: mobile ? "75%" : undefined }}
      >
        <Flexbox
          padding={8}
          gap={8}
        ...
        >
          <Center
            style={{ background: "#ffb224", color: "black" }}
      ...
      <Flexbox gap={24} align="center" style={{ width: "100%" }}>
        <div style={{ opacity: 1, transform: "none" }}>
          ...
          >
            <div className={styles.titleText}>{BRANDING_NAME}</div>
          </Flexbox>
        </div>
        ...
        <div style={{ opacity: 1, transform: "none" }}>
          <Center gap={16} horizontal>
            <Link
              style={{ height: "52px" }}
              href={
                "https://chat.aiqueue.ir/?utm_source=landing&utm_content=hero_get_started"
              }
            >
              <Button
